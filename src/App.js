  ...
  return (
    <div className="App">
      ...
      <main className="container">
        <TitleCard title="This is The New Title" />
          ...
          <div className="col-md-8">
            ...
            <article className="blog-post">
              ...
              <p className="blog-post-meta">
                January 1, 2021 by <a href="www.google.com">Mark</a>
              </p>
            ...
            <article className="blog-post">
              ...
              <p className="blog-post-meta">
                December 23, 2020 by <a href="www.google.com">Jacob</a>
              </p>
            ...
            <article className="blog-post">
              ...
              <p className="blog-post-meta">
                December 14, 2020 by <a href="www.google.com">Chris</a>
              </p>
            ...
            <nav className="blog-pagination" aria-label="Pagination">
              <a className="btn btn-outline-primary" href="www.google.com">
                Older
              </a>
              <a
                href="www.google.com"
